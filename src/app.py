...
from src.data.upload import show_upload
from src.data.prepare import show_prepare
from src.models.train import show_train
from src.models.test import show_test
from src.models.unsupervised import show_unsupervised
